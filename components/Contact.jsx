    ...
    return (
        <section className='lg:container lg:py-0 pt-20 lg:grid grid-cols-12 font-poppins space-y-8 items-center '>
            ...
            <div className='px-5 col-span-6 z-20 space-y-8'>
                <div className=' '>
                    <h1 className='text-[#F09804]  text-[44px]  font-bernier uppercase'>Contacter Nous</h1>
                    <h2 className='text-4xl font-semibold'>contactez-nous directement.</h2>
                </div>

                <p className='text-[#D4D4D4] leading-7 lg:w-[452px]'>
                    Dar D&apos;jaj HayMohammadi, Agadir. Spécialistes de la cuisson du poulet depuis 1978, nous mettons notre art au service de vos papilles😋
                </p>
                <div className='flex gap-5'>
                    ...
                    <h4 className='lg:text-2xl text-lg'>+212528230088 <br /> <span className='text-[#C4C4C4] text-sm'>Telephone</span></h4>
                </div>
                <div className='flex gap-5 py-4u'>
                    <Image src='/icon2png.png' width={50} height={50} className='w-[50px] h-[50px]' alt='icon' />
                    <h4 className='lg:text-2xl text-lg'>contact@dardjaj.ma  <br /> <span className='text-[#C4C4C4] text-sm'>Email</span></h4>
                </div>
                <div className='flex gap-5'>
                    <Image src='/icon3.png' width={50} height={50} className='w-[50px] h-[50px]' alt='icon' />
                    <h4 className='lg:text-2xl text-lg'>Résidence jardins de Souss 3 imm49 mag 22,  Hay Mohamadi Agadir 80080 <br /> <span className='text-[#C4C4C4] text-sm'>Adresse</span></h4>
                </div>
            </div>
