      ...
      <div className="lg:container space-y-7 font-poppins lg:grid grid-cols-12 py-10  items-start">
        <div className=" col-span-6 space-y-2 lg:space-y-6">
          <Image
            ...
            height={70}
          />
          <p className="lg:w-[460px] leading-9 pt-5 font-poppins text-[#A1A1A1]">
            Dar D&apos;jaj HayMohammadi, Agadir. <br /> Spécialistes de la
            cuisson du poulet depuis 1978, nous mettons notre art au service de
            vos papilles😋
          </p>
          <ul className="flex items-center gap-4">
            <li>
              <a
                className="divv"
                href="https://web.facebook.com/DarDjajAgadir/"
              >
                <svg
                  className="m-auto w-[26px]   "
            ...
            <li>
              <a
                className="hover:bg-primary rounded-sm  w-fit m-auto duration-500 bg-[#AAA] block"
            ...
            <li>
              <a
                className="hover:bg-primary rounded-sm  w-fit m-auto duration-500 bg-[#AAA] block"
                href="https://www.instagram.com/dar.djaj/ "
                target="_blanc"
              >
                <Image
                  src="/instagram-coreui-icons-v1-0-0.png"
                  width={24}
                  height={200}
                  alt=""
                />
          ...
          <ul className=" space-y-5 text-base">
            ...
            <li>
              <Link
                ...
                className={`${
                  active === "contact" ? "text-white" : "text-[#A1A1A1]"
                }`}
                href="/contact"
              >
                Nous Contacter
        ...
        <div className="col-span-3 flex flex-col  lg:space-y-5">
          ...
          <ul className=" space-y-5 lg:space-y-5 text-base text-[#A1A1A1]">
            <li className=" flex gap-3 items-start ">
              ...
              <p>
                Résidence jardins de Souss 3 imm49 mag 22, Hay Mohamadi Agadir
                80080
              </p>
            </li>
